...
const Sidebar = () => {
  ...
  return (
    <div className="w-72 h-screen fixed left-0 top-0 z-50 flex flex-col p-6 bg-[var(--bg-silk)] border-r border-[var(--glass-border)] shadow-[4px_0_24px_rgba(0,0,0,0.01)] overflow-hidden">
      {/* ── Brand Header ── */}
      ...
      <div className="mt-auto pt-8 border-t border-[var(--glass-border)] space-y-4">
        <div className="bg-[var(--bg-card)] rounded-2xl p-5 border border-[var(--glass-border)] shadow-sm">
        ...
        >
          ...
          <span className="font-bold text-[13px] tracking-tight">Take a Break</span>
        </button>
